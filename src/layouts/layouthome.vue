...
<div>
    <header class="header-home bg-transparent" :class="{'scroll-header-top':scrolled}">
        <div class="row g-0 pe-lg-3 pe-xl-5"><!-- Start: logo -->
            <div class="col-2 col-xl-2 d-none d-lg-none d-xl-block"><nuxt-link class="poiter" to="/">
                    <div class="d-xl-flex justify-content-xl-center align-items-xl-center bg-black px-5 logo-header-layout" style="display: flex;flex-direction: column;width: 100%;"><b-img class="w-100 obj-contain" style="/*width: 100%;*/" :src="webConfig.logoHeader" :alt="webConfig.ceoTitle" lazy></b-img></div>
                </nuxt-link></div><!-- End: logo -->
            <div class="col-8 col-xl-10 col-xxl-10 d-none d-xl-flex justify-content-xxl-center">
                <div style="width: 100%;display: flex;">
                    <div class="d-flex justify-content-xl-center align-items-xl-center" style="flex: 1;">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item"><!-- Start:  id:sZxiw13PcF3zG3iuaq8xwd-debug-component-ldr --><nuxt-link class="nav-link sZxiw13PcF3zG3iuaq8xwd-preview-css-ldr nav-header-hover txt-header poiter text-decoration-none" to="/contact" :class="{'text-dark':scrolled}">
                                    <div class="d-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center hover-yellow font-size-reponsive-header">
                                        <p class="text-uppercase">contact</p>
                                    </div>
                                </nuxt-link><!-- End:  id:sZxiw13PcF3zG3iuaq8xwd-debug-component-ldr --></li>
                        </ul>
                    </div>
                    <div class="d-flex justify-content-center align-items-center flex-xl-column px-sm-3 px-xl-0" style="width: 196px;/*align-items: center !important;*/"><nuxt-link to="/contact/virtual-consultation/">
    ...
    <section class="reponsive-section-2 margin-top-section section-ft-layout" :style="{'background-image':'url(&quot;'+webConfig.backroundFooter+'&quot;)'}">
        ...
        <div class="text-white bg-footer">
            <div class="px-xl-5">
                <div class="row g-0 px-xl-5">
                    <div class="col-12 col-xl-4 d-flex d-xxl-flex flex-column justify-content-center align-items-center justify-content-xl-center align-items-xl-start order-xl-first align-items-xxl-start px-2 py-3 py-xl-0">
                    ...
                    <div class="col-12 col-xl-4 d-xl-flex order-first justify-content-xl-center align-items-xl-center py-3 py-xl-0"><nuxt-link to="/">
                            <div class="d-flex d-xxl-flex justify-content-center align-items-center justify-content-xxl-center align-items-xxl-center"><b-img class="btn-hover img-fluid max-height-img-footer" :src="webConfig.logoHeader" :alt="webConfig.ceoTitle" lazy></b-img></div>
                        </nuxt-link></div>
...
//update in Thu Aug 15 2024 14:57:04 GMT+0700 (Indochina Time) by loidirieng
